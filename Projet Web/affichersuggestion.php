...
require_once '../Core/suggestionC.php';
		...
		$res=$suggestion->affichersuggestion();
...
<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Basic Implementation</h2>
						...
						<tbody>
							<?php foreach ($res as $suggestion) {
								# code...
							?>
						  <tr>
							<td><?php echo $suggestion["idUtilisateur"] ;?></td>
...
<!--Go Gestion produit.php-->								
									<li><a href="#"><span>Produits</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									  <ul>
										<li><a href="ajout.html"> Ajouter produit</a></li>
