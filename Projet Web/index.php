...
<html>
<head>
<title>Mounir Optique | Home</title>
<!--/tags -->
...
<link rel="stylesheet" type="text/css" href="css/invictus.css">
...
<div class="header" id="home">
	<div class="container">
		<ul>
			...
			<li><i class="fa fa-phone" aria-hidden="true"></i> Call : +216 23 230 280</li>
			<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com">mounirmohamed@outlook.fr</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>M</span>ounir Optique <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
		<div class="col-md-4 agileits-social top_content">
						<ul class="social-nav model-3d-0 footer-social w3_agile_social">
						                                   <li class="share">Share On : </li>
															...
															<li><a href="https://www.instagram.com/mouniroptic/" class="instagram" target="_blank">
...
<!--add  style="flex-wrap: nowrap;" at ul if you want them all to be at one line  @Invictus-->				  
					<ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="index.html">Home <span class="sr-only">(current)</span></a></li>
					<li class=" menu__item"><a class="menu__link" href="about.html">About</a></li>
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Lunettes Homme <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img class="illustration" src="images/LunettesHomme.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li ><a href="mens.html" class="level1" onmouseover="setIllustration('images/LunettesHomme.jpg')" style="font-size : 15px;">Lunettes De Vue</a></li>
											<li><a href="mens.html" onmouseover="setIllustration('images/LunettesUnifocales.jpg')">Lunettes Unifocales</a></li>
											<li><a href="mens.html" onmouseover="setIllustration('images/LunetesProgressives.jpg')">Lunetes Progressives</a></li>
											<li><a href="mens.html" onmouseover="setIllustration('images/LunettesDeSport.jpg')">Lunettes De Sport</a></li>
											<li><a href="mens.html" onmouseover="setIllustration('images/LunettesDigitalRelax.jpg')">Lunettes Digital Relax</a></li>
											<li><a href="mens.html" onmouseover="setIllustration('images/LunettesDegressives.jpg')">Lunettes Dégressives</a></li>
											
										</ul>
									</div>
<!-- this part is removed by me
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
...
-->
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Lunettes Femme <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-4 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html" class="level1">Lunettes De Vue</a></li>
											<li><a href="mens.html">Lunettes Unifocales</a></li>
											<li><a href="mens.html">Lunetes Progressives</a></li>
											<li><a href="mens.html">Lunettes De Sport</a></li>
											<li><a href="mens.html">Lunettes Digital Relax</a></li>
											<li><a href="mens.html">Lunettes Dégressives</a></li>
...
-->
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="images/LunettesFemme.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">Essayer Lunettes<b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="essayerLunettesEnLigne.html">En Ligne</a></li>
								</ul>
					</li>
					<li class=" menu__item"><a class="menu__link" href="contact.html">Contact</a></li>
<!--IwasHere-->		<li class=" menu__item dropdown">
						<a class="menu__link" href="comment.html">Comment?</a>
					</li>
<!--If we want to make that shopping box in the left
					<li class="menu__item">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign In <span>Now</span></h3>
									<form action="http://localhost/projet/FrontOffice/Core/login.php" method="post">
						...
						<?php } else { ?>
												<h3 >Deconnect <span><?php echo $_SESSION["Username"]; ?></span></h3>
<?php } ?>
...
<!-- Modal2 -->
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<!--
						 <form action="../Core/ajouterClient.php" method="post">
							...
							<div class="styled-input">
								<input type="codepostal" name="codepostal" required=""> 
								<label>codePostal</label>
								<span></span>
							</div> 
							<div class="styled-input">
								<input type="sexe" name="sexe" required=""> 
								<label>sexe</label>
								<span></span>
							</div> 
							...
							<div class="styled-input">
								<input type="etat" name="etat" required=""> 
								<label>etat</label>
								<span></span>
							</div> 
							<div class="styled-input">
	...
	<form method="post" action="Core/ajouterClient.php" enctype="multipart/form-data">
		
	  	<div class="form-group">
	    	<label for="nom">nom</label>
	   		<input type="text" class="form-control styled-input" name="nom" id="nom" required=""  >
	  	</div>
	  	<div class="form-group">
	    	<label for="prenom">prenom</label>
	   		<input type="text" class="form-control styled-input" name="prenom" id="prenom" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="tel">tel</label>
	   		<input type="Number" class="form-control styled-input" name="tel" id="tel" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="adresse">adresse</label>
	   		<input type="text" class="form-control styled-input" name="adresse" id="adresse" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="codePostal">codePostal</label>
	   		<input type="text" class="form-control styled-input" name="codePostal" id="codePostal" required="">
	  	</div>
	  	<div class="form-group">
			...
			<input type="checkbox" name="dmc" onclick="action()">
      			...
      			<option value="fiat">Femme</option>
	  	</div>
	  	<div class="form-group">
	    	<label for="cin">cin</label>
	   		<input type="Number" class="form-control styled-input" name="cin" id="cin" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="email">email</label>
	   		<input type="email" class="form-control styled-input" name="email" id="email" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="login">login</label>
	   		<input type="text" class="form-control styled-input" name="login" id="login" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="password">password</label>
	   		<input type="text" class="form-control styled-input" name="password" id="password" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="etat">etat</label>
	   		<input type="text" class="form-control styled-input" name="etat" id="etat" required="">
	  	</div>
	  	<div class="form-group">
	    	<label for="role">role</label>
	   		<input type="text" class="form-control styled-input" name="role" id="role" required="">
	  	</div>
					...
					<!--/tab_one-->
						<div class="tab1">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/m4.png" alt="" class="pro-image-front">
										<img src="images/m4.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/m5.png" alt="" class="pro-image-front">
										<img src="images/m5.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/m7.png" alt="" class="pro-image-front">
										<img src="images/m7.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/m6.png" alt="" class="pro-image-front">
										<img src="images/m6.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/m8.png" alt="" class="pro-image-front">
										<img src="images/m8.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						...
						<div class="tab2">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/w5.png" alt="" class="pro-image-front">
										<img src="images/w5.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/w6.png" alt="" class="pro-image-front">
										<img src="images/w6.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						    ...
						    <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/w7.png" alt="" class="pro-image-front">
										<img src="images/w7.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/w8.png" alt="" class="pro-image-front">
										<img src="images/w8.png" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		<div class="col-md-3 footer-left">
			<h2><a href="index.html"><span>M</span>ounir Optique </a></h2>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="mens.html">Lunettes Homme</a></li>
						<li><a href="womens.html">Lunettes Femme</a></li>
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="mailto:mounirmohamed@outlook.fr"> mounirmohamed@outlook.fr</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Location</h6>
								<p>109 av de la liberté 1002 Tunis. 
...
<script type="text/javascript" src="js/invictus.js"></script>
</body>
</html>
