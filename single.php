                  ...
                  <div class="responsive_tabs">
                     <div id="horizontalTab">
                        ...
                        <div class="resp-tabs-container">
                                    ...
                                    <div class="add-review">
                                       ...
                                       <form action="ajoutAvis.php" method="post">
                                          <div class="row">
                                             ...
                                             <div class="col-md-6">
                                                <label class="control-label">Email Addrese</label>
                                                <input type="email" name="email" required="">
                                             </div>
                                             <div class="col-md-6">

                                                <input type="hidden" name="id_produit" value="<?php echo $_GET['id'];?>" required="">
                                             </div>
                                          </div>
                           ...
                           <div class="tab3">
                              <div class="single_page">
                                 <h6>AFFICHAGE AVIS</h6>
                                 
                                    <?php 

                                 $aviss=$avis2C->afficherAvis($_GET['id']);
                                 foreach ($aviss as $avis) {
                                       $produit=$avis2C->rechercherProduit($avis->idProduit);
                                       $client=$avis2C->rechercherClient($avis->idClient);
                                 ...
                                 <p>
                                    ...
                                    <div class="col-md-6">
                                       <input type="hidden" name="numAvis" value="<?php echo $avis->numAvis;?>" >
                                       <input type="hidden" name="id_produit" value="<?php echo $_GET['id'];?>" >
                                    </div>
                                    <div> 
                                   <label class="control-label">Nom des User</label>
                                   <input type="text" name="nom" value="<?php echo $client[0]->nom;?>">
                                 </div>
                                  
                                   <div>
                                    <label class="control-label">Commentaire</label>
                                   <textarea name="commentaire" ><?php echo $avis->commentaire;?></textarea>
                                   </div>


                                   <div>
                                       <label class="control-label">NOM Produit</label>
                                   <input type="text" name="idProduit" value="<?php echo $produit[0]->nom;?>">

                                   </div>

                                   <div> <input type="submit" value="MODIFIER"> </br>  
                                          <a href="supprimerAvis.php?numAvis=<?php echo $avis->numAvis?>&id=<?= $_GET['id']?>"><input type="button" value="Supprimer"></a></div>
