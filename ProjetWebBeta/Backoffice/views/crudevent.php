                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">CRUD d'evenements</h2>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Formulaire d'ajout d'evenement</h5>
                                <div class="card-body">
                                    <form action="ajouterEvent.php" method="post" id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="inputEventId">Titre</label>
                                            <input id="id" type="text" name="titre" data-parsley-trigger="change" required="" placeholder="Enter the title" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEventId">Description</label>
                                            <input id="id" type="text" name="description" data-parsley-trigger="change" required="" placeholder="Enter the description" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEventId">Adresse</label>
                                            <input id="id" type="text" name="adresse" data-parsley-trigger="change" required="" placeholder="Enter the address" autocomplete="off" class="form-control">
                                        </div>

                                        <div class="form-group">
                                            <label for="inputEmail">Date</label>
                                            <input id="inputEmail" type="date" name="date" data-parsley-trigger="change" required="" placeholder="Enter the date" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail">Heure</label>
                                            <input id="inputEmail" type="time" name="heure" data-parsley-trigger="change" required="" placeholder="Enter the time" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputEmail" type="text" name="type" data-parsley-trigger="change" required="" placeholder="Enter the type of the Event" autocomplete="off" class="form-control">
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Liste des evenements</h5>
                                <div class="card-body">
                                    <?PHP
                                    include "../core/eventCore.php";
                                    include "../entities/event.php";
                                    $eventC=new EventCore();
                                    $liste=$eventC->afficher();

                                    ?>
                                    <table id="tableevent" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th scope="col">Id</th>
...
<tr>
    ...
    <td name="adresse" > <?php echo $row['adresse']; ?> </td>
    <td name="date" > <?php echo $row['date']; ?> </td>
    <td name="heure" > <?php echo $row['heure']; ?> </td>
    <td name="type" > <?php echo $row['type']; ?> </td>
    <td name="type" > <?php echo $row['Image']; ?> </td>
</tr>
<?php 
}
 ?>
    ...
    $(document).ready(function () {
        $('#tableevent').dataTable();
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Formulaire de suppression d'evenement</h5>
                                <div class="card-body">
                                    <form action="supprimerEvent.php" method="post" id="basicform" data-parsley-validate="">
                                        <div class="form-group">
                                            <label for="inputEventId"></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="with">
                                                ...
                                                <option value="Reference">Identifiant</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Formulaire de modification d'evenement</h5>
                                <div class="card-body">
                                    <form action="modifierEvent.php" method="post" id="basicform" data-parsley-validate="">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEventId"></label>
                                            <input id="id" type="text" name="ref" data-parsley-trigger="change" required="" placeholder="Enter the reference to the event" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEventId"></label>
