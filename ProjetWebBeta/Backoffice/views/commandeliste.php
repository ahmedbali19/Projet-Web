        ...
        <!-- ============================================================== -->
         <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../index.html">Madame Jedidi</a>
       ...
       <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="#">Acceuil</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>Commandes <span class="badge badge-success">6</span></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Tables Commandes
																</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="href="commandeliste.php">commandes</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="commandeliste.php"> Tables de commandes</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Table De Commandes</h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="commandeliste.php" class="breadcrumb-link">Les Commandes</a></li>
                                        <li class="breadcrumb-item"><a href="lignecommande.php" class="breadcrumb-link">Tables Commandes</a></li>
                    ...
                    <!-- ============================================================== -->
										<table id="example" class="table table-striped table-bordered " style="width:110%">
											...
											<tr>
																 ...
																 <td><?php echo $commande["mode_paiement"] ;?></td>
																 <td><?php echo $commande["mail"] ;?></td>

															 <?php	$_SESSION['var'] = $commande["id_commande"];?>
																 <td><a class="btn btn-primary" href="lignecommande.php?id=<?php echo $commande["id_commande"]; ?>">Voir</a></td>
																 <td><a class="btn btn-danger" href="supprimerCommande.php?id=<?php echo $commande["id_commande"] ?>">Annuler commande</a></td>
										        ...
										        <tfoot>
									 			...
									 			<td> <form method="POST" action="imprimer.php">
																					 <button name="imprimer" >imprimer</button>
																				 </form></td>
