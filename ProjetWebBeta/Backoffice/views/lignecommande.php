...
require_once '../core/lignecommande.php';
		$commande=new lignecommandeC();
		if (isset($_GET["id"]))
		{
			$res=$commande->afficherligneCommandeJoin($_GET["id"]);
			$res2 = $commande->afficherligneCommandeJoin($_GET["id"]);
			foreach ($res2 as $re) {
			  echo $re['image'];
			}
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="commandeliste.php">Data Tables</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>prix</th>
																				...
																				<td><img width="100px" height="100px" style=" border-radius: 50%;" src="../../Frontoffice/<?php echo $commande["image"] ;?>"></td>
